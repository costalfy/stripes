...
<stripes:layout-render name="/bugzooky/layout/standard.jsp" title="Add/Edit Bug">
    <stripes:layout-component name="contents">
        ...
        <stripes:form beanclass="net.sourceforge.stripes.examples.bugzooky.SingleBugActionBean"
            ...
            <table class="leftRightForm">
                ...
                <tr>
                    ...
                    <td><stripes:select name="bug.component">
                        <stripes:options-collection collection="${componentManager.allComponents}" label="name"
                                                    value="id"/>
                    </stripes:select></td>
                </tr>
                <tr>
